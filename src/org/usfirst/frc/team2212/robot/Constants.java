...
public class Constants {
	...
	public static Supplier<Double> KP = ConstantHandler.addConstantDouble("KP", 0.008);
	public static Supplier<Double> KI = ConstantHandler.addConstantDouble("KI", 0.0);
	public static Supplier<Double> KD = ConstantHandler.addConstantDouble("KD", 0.005);
	...
	public static final Supplier<Double> targetWidth = ConstantHandler.addConstantDouble("targetWidth", 110);
	public static PIDSource widthSource = new PIDSource() {
		...
		public double pidGet() {
			// TODO Auto-generated method stub
			return Constants.cameraInfo.getNumber("width", 200);
		}
